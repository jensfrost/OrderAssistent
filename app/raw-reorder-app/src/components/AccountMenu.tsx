...
export const HeaderAccountButton: React.FC = () => {
    ...
    return (
        <TouchableOpacity onPress={toggle} style={styles.pill}>
...
export const AccountMenuOverlay: React.FC = () => {
    ...
    const envName = process.env.EXPO_PUBLIC_ENV_NAME ?? process.env.EXPO_PUBLIC_ENV ?? 'dev';
        ...
        <Pressable style={styles.overlay} onPress={close}>
            <Pressable style={styles.menu} onPress={(e) => e.stopPropagation()}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => {
                        close();
                        navigation.navigate('InstallApp');
                    }}
                >
                    <Text style={styles.menuText}>
                        {i18n.t('app.installApp') || 'Installera appen'}
                    </Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={() => setLocale('sv')} style={styles.langItem}>
                    <Text style={styles.menuText}>Svenska</Text>
                    <Text>{locale === 'sv' ? '●' : '○'}</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => setLocale('en')} style={styles.langItem}>
